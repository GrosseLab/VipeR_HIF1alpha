...
### call 
# python2 DAVID.py -i geneList.csv -o "./testRES" -d DAVID_6_8 -t "ENSEMBL_GENE_ID"
...
if DAVID == "DAVID_6_8":
    ...
    print '--DAVID/-d must be "DAVID_6_8" or "DAVID_6_7"'
    sys.exit(2)
...
client.service.authenticate('claus.weinholdt@informatik.uni-halle.de')
...
# setCategories
categorySting = str(client.service.setCategories('BBID,BIOCARTA,COG_ONTOLOGY,GOTERM_BP_FAT,GOTERM_CC_FAT,GOTERM_MF_FAT,INTERPRO,KEGG_PATHWAY,OMIM_DISEASE,PIR_SUPERFAMILY,SMART,SP_PIR_KEYWORDS,UP_SEQ_FEATURE,GOTERM_BP_DIRECT,GOTERM_CC_DIRECT,GOTERM_MF_DIRECT'))
print categorySting
...
# getChartReport
#
threshold = 0.1 #EASE Score, a modified Fisher Exact P-Value https://david-d.ncifcrf.gov/helps/functional_annotation.html#fisher
